...
//按键“图书查询"响应界面
public class UserSearchPanel extends JPanel implements ActionListener, ListSelectionListener {
    ...
    private Box createBookTypeManageVBox() {
        ...
        bookTypeManageLabel = new JLabel("用户查询");
        ...
        // 将表格设置为滚动面板内容视图
        tableScrollPanel.setViewportView(this.createTable("select 学号,班级,姓名,剩余可借数目 from users"));
        // 设置滚动面板预定义尺寸
